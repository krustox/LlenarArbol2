...
class EnterprisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enterprise" do
    assert_difference('Enterprise.count') do
      post enterprises_url, params: { enterprise: { display_empresa: @enterprise.display_empresa, empresa_id: @enterprise.empresa_id, holding_id: @enterprise.holding_id, nombre_empresa: @enterprise.nombre_empresa } }
    end
  ...
  test "should update enterprise" do
    patch enterprise_url(@enterprise), params: { enterprise: { display_empresa: @enterprise.display_empresa, empresa_id: @enterprise.empresa_id, holding_id: @enterprise.holding_id, nombre_empresa: @enterprise.nombre_empresa } }
