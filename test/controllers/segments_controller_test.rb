...
class SegmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create segment" do
    assert_difference('Segment.count') do
      post segments_url, params: { segment: { agrupacion_id: @segment.agrupacion_id, display_segmento: @segment.display_segmento, nombre_segmento: @segment.nombre_segmento, segmento_id: @segment.segmento_id } }
    end
  ...
  test "should update segment" do
    patch segment_url(@segment), params: { segment: { agrupacion_id: @segment.agrupacion_id, display_segmento: @segment.display_segmento, nombre_segmento: @segment.nombre_segmento, segmento_id: @segment.segmento_id } }
