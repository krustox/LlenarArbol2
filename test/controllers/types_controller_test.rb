...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { display_tipo: @type.display_tipo, nombre_tipo: @type.nombre_tipo, servicio_id: @type.servicio_id, tipo_id: @type.tipo_id } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { display_tipo: @type.display_tipo, nombre_tipo: @type.nombre_tipo, servicio_id: @type.servicio_id, tipo_id: @type.tipo_id } }
